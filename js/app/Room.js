...
define([ "three", "physics" ], function ( THREE, physics ) {
    ...
    function Room ( length, width, height, door ) {
    ...
    */
    ...
    Room.prototype.addStairs = function( room ) {
    ...
    Room.prototype.createCeiling = function ( width, wallThickness, depth, height ) {
